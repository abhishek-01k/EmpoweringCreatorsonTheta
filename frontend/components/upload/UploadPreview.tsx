...
const UploadPreview = () => {
    ...
    const handleUpload = async () => {
        ...
        if (!title || !description || !price || !previewVideoFile) return;
    ...
    return (
        <Card className="max-w-[450px]">
            ...
            <CardFooter>
                <Button
                    disabled={isUploading || (!title || !description || !price || !previewVideoFile) || !!previewVideoId}
                    onClick={handleUpload}
                >
                    {isUploading ? "Uplaoding..." : previewVideoId ? "Uploaded" : "Upload"}
                </Button>
            </CardFooter>
        </Card>
    );
